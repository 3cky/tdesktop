...
private:
	...
	std::vector<int> _scales = { 4, 5, 6, 8, 10, 12 }; // scale / 4 gives our 1.00, 1.25, 1.50, 2.00, 2.50, 3.00
	std::vector<const char *> _scaleNames = { "dbisOne", "dbisOneAndQuarter", "dbisOneAndHalf", "dbisTwo", "dbisTwoAndHalf", "dbisThree" };
